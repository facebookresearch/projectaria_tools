...
Start with the [Python Tutorials](/research-tools/projectariatools/overview#python-notebook-tutorials) to learn the basics:
...
4. **Device Time Alignment** - Timestamp queries and multi-device alignment
5. **MPS Basics** - Load machine perception output
