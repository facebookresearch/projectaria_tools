...
The `aria_viewer` is a C++ binary that provides real-time visualization of Aria VRS data using the Pangolin framework. It offers native performance for visualizing multi-modal sensor data from Aria devices.
