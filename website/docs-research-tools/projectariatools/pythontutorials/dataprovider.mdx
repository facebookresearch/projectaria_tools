...
<TutorialButtons
  notebookUrl="https://github.com/facebookresearch/projectaria_tools/blob/2.1.0/examples/Gen2/python_notebooks/Tutorial_1_vrs_data_provider_basics.ipynb"
  colabUrl="https://colab.research.google.com/github/facebookresearch/projectaria_tools/blob/2.1.0/examples/Gen2/python_notebooks/Tutorial_1_vrs_data_provider_basics.ipynb"
/>
...
```
where `<SENSOR>` can be replaced by any sensor data type available in Aria VRS. See here for [a full list of supported sensor types](https://github.com/facebookresearch/projectaria_tools/blob/2.1.0/core/data_provider/VrsDataProvider.h#L377)
