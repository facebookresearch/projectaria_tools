...
<TutorialButtons
  notebookUrl="https://github.com/facebookresearch/projectaria_tools/blob/2.1.0/examples/Gen2/python_notebooks/Tutorial_5_on_device_vio.ipynb"
  colabUrl="https://colab.research.google.com/github/facebookresearch/projectaria_tools/blob/2.1.0/examples/Gen2/python_notebooks/Tutorial_5_on_device_vio.ipynb"
/>
...
structure [defined in MPS](https://github.com/facebookresearch/projectaria_tools/blob/2.1.0/core/mps/Trajectory.h).
