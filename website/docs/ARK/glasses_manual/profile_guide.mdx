...
This page provides the recording profiles needed for Machine Perception Services(MPS) and an overview of Aria sensor recording profiles that are commonly used when collecting Aria data.
...
If you would like more details about any recording profile:
...
|***Profile4***	|RGB high frame rate JPEG with audio	|No	|No	|
|***Profile5***	|Eye tracking calibration (high res)	|No	|Yes	|
|***Profile7***	|RGB high frame rate RAW with audio	|No	|No	|
