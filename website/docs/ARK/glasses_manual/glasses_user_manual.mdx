...
---
# Aria Glasses User Manual

The Aria Research Kit (ARK) provides Aria glasses, services and tools to enable researchers to gather and process their own Aria data. Go to [Aria Research Kit intro page](https://projectaria.com/research-kit/) to find out more or to apply for the ARK.
...
![Aria on LED](/img/ARK/glasses_manual/aria_power_button.png)

### Powering Off

_Hold the power button for 5 seconds and release_.
Powering off will NOT be instantaneous. It may take several seconds for the LED to turn off.
...
![Bystander LED](/img/ARK/glasses_manual/bystander_LED.png)
...
You can find the Device ID for your glasses in the Mobile Companion App Device Settings (select the settings/gear icon next to your glasses on the dashboard).
