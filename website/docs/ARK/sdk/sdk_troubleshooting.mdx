...
## Overview
This page provides troubleshooting information for using Project Aria Client SDK or CLI. If you cannot find a solution for your problem on this page, please contact our team:
...
* [Aria Glasses User Manual](https://facebookresearch.github.io/projectaria_tools/docs/ARK/glasses_manual/glasses_user_manual) for general information about using your glasses.
* [Aria Research Kit (ARK) Troubleshooting and Known Issues page](https://facebookresearch.github.io/projectaria_tools/docs/ARK/troubleshooting/troubleshooting_issues) for general Aria Glasses troubleshooting information.
