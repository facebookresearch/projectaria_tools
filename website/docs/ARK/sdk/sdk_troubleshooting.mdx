...
* Running `aria-diagnostics` in your Python environment will create a diagnostic report file called *diagnostics.zip* in the same folder you're currently working in. You can send this collection of logs to the most relevant location listed under [How do I get support/report issues?](/support.mdx#how-do-i-get-supportreport-issues).
