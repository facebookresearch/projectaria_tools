...
Once you've completed recordings with your Aria Glasses you can access and download these recordings using the Desktop Companion app (go to the [Aria Glasses Quickstart guide](https://facebookresearch.github.io/projectaria_tools/docs/ARK/ARK_quickstart) to see other ways to download your data).
...
![Visualizer layout options](/img/ARK/desktopapp_menubar_layout.png)
