...
1. Download Aria's DMG installer from [here](https://foreign-service-public-assets.s3.us-west-2.amazonaws.com/apps/mac/Aria_v37.dmg)
2. Open the downloaded file
3. Drag and drop Aria.app to your Applications folder
4. Double clicking on Aria.app to open it up

### Aria For Windows Installer

1. Download Aria's Windows installer from [here](https://foreign-service-public-assets.s3.us-west-2.amazonaws.com/apps/windows/Aria_v37.msi)
...
1. Download Aria's Linux debian package from [here](https://foreign-service-public-assets.s3.us-west-2.amazonaws.com/apps/linux/Aria_v36.deb)
