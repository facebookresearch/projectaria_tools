...
2. If you’re only using our CLI directly instead of Aria Studio, you can just update to Projectaria_tools 1.5.5 using `pip install projectaria_tools --upgrade`. This will be handled automatically if you update or re-install Aria Studio.
