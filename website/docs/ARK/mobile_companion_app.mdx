...
To make sure you get the latest device features and bug fixes, you should frequently check for the latest OS updates in Aria device settings.
...
In the Recordings menu, you'll be able to see recordings that are currently on your Aria device.
...
On the main Aria Dashboard in the Mobile app, select the settings (gear) icon next to your Aria device to view your Aria device's settings.

![Device Settings](/img/ARK/mobile_app_device_settings.png)

The Aria device settings page's contents include:
