...
* Accept, store and delete security certificates to enable the [Client SDK and CLI](/docs/ARK/sdk)
...
4. Perform in-session Eye Gaze Calibration (optional)
    ...
    * Go To [Eye Gaze Calibration](/docs/ARK/mps/eye_gaze_calibration) for more information
