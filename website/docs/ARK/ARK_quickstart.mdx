...
The Capture button is located on the top right of your glasses. The capture button will use the recording profile set by the Desktop App.
...
Please note, this does not change the name of the VRS file, it changes the Name and Notes properties in the associated vrs.json file.
