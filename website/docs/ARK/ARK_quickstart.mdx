...
Once you've set up your glasses with the Mobile Companion app, researchers can use the Client SDK or CLI to directly interact with Aria glasses.

Go to the [Client SDK and CLI section](/docs/ARK/sdk) for how to install these tools.

## Record Data

It's best to start and stop recording using the Capture button, Mobile Companion app, the CLI or SDK.
