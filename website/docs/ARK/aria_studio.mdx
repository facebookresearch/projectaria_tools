...
* Mac ARM: Download the [Package for ARM](https://foreign-service-public-assets.s3.us-west-2.amazonaws.com/apps/AriaStudio/Aria_Studio-1.0.1-arm64.pkg)
* Mac Intel: Download the [Package for Intel](https://foreign-service-public-assets.s3.us-west-2.amazonaws.com/apps/AriaStudio/Aria_Studio-1.0.1-Intel.pkg)
* Windows: Download the [Package for Windows](https://foreign-service-public-assets.s3.us-west-2.amazonaws.com/apps/AriaStudio/Aria_Studio-1.0.1-windows.exe)
* Linux: Download the [Package for Linux](https://foreign-service-public-assets.s3.us-west-2.amazonaws.com/apps/AriaStudio/Aria_Studio-1.0.1-Linux.AppImage)
