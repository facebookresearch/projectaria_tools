...
* x64 Linux distributions of:
    ...
    * **Note:** Aria Studio 1.1.0 (the most recent version) can only be installed on Linux via [pip install](#install-aria-studio-via-pypi).
...
* Mac ARM: Download the [Package for Mac ARM](https://foreign-service-public-assets.s3.us-west-2.amazonaws.com/apps/AriaStudio/Aria_Studio-1.1.0-arm64.dmg)
* Windows: Download the [Package for Windows](https://foreign-service-public-assets.s3.us-west-2.amazonaws.com/apps/AriaStudio/Aria_Studio-1.1.0-windows.exe)
* Linux: Download the [Package for Linux](https://foreign-service-public-assets.s3.us-west-2.amazonaws.com/apps/AriaStudio/Aria_Studio-1.1.0-Linux.appimage)
...
#### Note: Version 1.0.3 requires unsigned builds
