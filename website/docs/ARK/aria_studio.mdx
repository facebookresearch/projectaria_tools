...
Go to the [Quickstart Guide](/ARK/ARK_quickstart.mdx) for how to start using them.
:::
...
Install the package appropriate for your computer platform. This is a new feature for this release. Double-click on the downloaded file and follow the prompts to complete the installation.
* Mac ARM: Download the [Package for ARM](https://foreign-service-public-assets.s3.us-west-2.amazonaws.com/apps/AriaStudio/Aria_Studio-1.0.2-arm64.pkg)
* Mac Intel: Download the [Package for Intel](https://foreign-service-public-assets.s3.us-west-2.amazonaws.com/apps/AriaStudio/Aria+Studio-1.0.2-Intel.pkg)
* Windows: Download the [Package for Windows](https://foreign-service-public-assets.s3.us-west-2.amazonaws.com/apps/AriaStudio/Aria_Studio-1.0.2-windows.exe)
* Linux: Download the [Package for Linux](https://foreign-service-public-assets.s3.us-west-2.amazonaws.com/apps/AriaStudio/Aria_Studio-1.0.2-Linux.AppImage)
...
:::note
If you're going to install Aria Studio via PyPI, you'll want a Python version from 3.10 to 3.12. To To check which version of Python 3 you have, use `python3 --version`. Get the latest version from the [Python 3 download page](https://www.python.org/downloads/)
:::
...
When using PyPI's `pip` command, it's a best practice to use a virtual environment. This will keep all the modules in one folder and avoiding breaking anything in your local environment. To install Aria Studio in a virtual environment, use the following steps:
