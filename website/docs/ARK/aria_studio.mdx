...
:::note
If you're going to install Aria Studio via PyPI, you'll want a Python version from 3.10 to 3.12. To check which version of Python 3 you have, use `python3 --version`. Get the latest version from the [Python 3 download page](https://www.python.org/downloads/)
:::
