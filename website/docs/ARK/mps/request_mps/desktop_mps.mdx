...
This page provides information about how academic research partners who have access to the [Aria Research Kit (ARK)](https://www.projectaria.com/research-kit/) can request [Machine Perception Services (MPS)](/docs/ARK/mps) using the Desktop Companion App. The Desktop Companion app is available on [Windows, MacOS and Linux](/ARK/about_ARK.mdx#other-requirements-optional-software).

:::info Try the MPS CLI!
We recommend using the [MPS CLI](mps_cli.mdx) to submit requests as it contains additional capabilities, such as resumable uploads and Multi-SLAM MPS
:::
