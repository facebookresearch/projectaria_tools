...
title: Desktop App MPS Requests
---
...
This page provides information about how academic research partners who have access to the [Aria Research Kit (ARK)](https://www.projectaria.com/research-kit/) can request [Machine Perception Services (MPS)](/docs/ARK/mps) using the Desktop Companion App. The Desktop Companion app is available on [Windows, MacOS and Linux](/ARK/ark_downloads.mdx#desktop-companion-app).

:::info Try the MPS CLI or Aria Studio!
We recommend using the [MPS CLI](mps_cli.mdx) or [Aria Studio](/ARK/aria_studio.mdx) to submit requests as they contain additional capabilities, such as resumable uploads and Multi-SLAM MPS
:::
...
Once your data has been successfully processed, you can download the derived data zip file, from the Recordings toolbar. Please refer to the [MPS Loader APIs](/docs/data_utilities/core_code_snippets/mps#load-mps-output) on how to load the output in Python/C++ and [Python visualization](/docs/data_utilities/visualization/visualization_python#run-mps-viewer), [C++ Visualization](/docs/data_utilities/visualization/visualization_cpp#mps-static-scene-visualizer) guides. on how to run the rich visualization tools to visualize all the MPS outputs.
