...
The Project Aria Machine Perceptions Services Command Line Interface (MPS CLI) is a command line tool used to request and receive [Machine Perception Services](/ARK/mps/mps.mdx). This page provides basic information to get you started with the MPS CLI, go to the [MPS CLI Guide](mps_cli_guide.mdx) for more details.
...
Please follow this table to install the MPS CLI:
<table>
 <tr>
 <td><strong>Platform</strong></td>
 <td><strong>Installation Steps</strong></td>
 </tr>
 <tr>
 <td><strong>Mac/Linux</strong></td>
 <td>Please follow the latest [MPS CLI installation guide](https://facebookresearch.github.io/projectaria_tools/gen2/ark/mps/start#install-project-aria-mps).</td>
 </tr>
 <tr>
 <td><strong>Windows</strong></td>
 <td>Windows support for the new MPS CLI package is coming soon. Until then, please continue to use [pip installation version of Project Aria Tools](/data_utilities/installation/installation_python.mdx).</td>
 </tr>
 </table>
