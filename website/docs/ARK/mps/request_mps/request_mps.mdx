...
Users can also use the [Desktop Companion app](/ARK/mps/request_mps/desktop_mps.mdx) to request MPS, however it does not contain MPS CLI capabilities, such as resumable uploads, automatic downloads and the ability to request Multi-SLAM MPS.
