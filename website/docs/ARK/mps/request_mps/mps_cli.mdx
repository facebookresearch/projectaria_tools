...
While research partners can use the [Desktop Companion app](desktop_mps.mdx) to request MPS, Aria MPS CLI and Aria Studio provide more features and can resume uploads if interrupted.
