...
# Request Machine Perceptions Services (MPS)

## Overview

This page provides information about how to request MPS for academic research partners who have access to the [Aria Research Kit (ARK)](https://www.projectaria.com/research-kit/).
