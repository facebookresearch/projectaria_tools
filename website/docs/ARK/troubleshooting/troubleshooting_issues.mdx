...
It covers:
  ...
  - [Machine Perception Services Issues and Error Messages](#machine-perception-services-mps)
...
If you need further support, have feedback or feature requests, please email [_AriaOps@meta.com_](mailto:AriaOps@meta.com), post to [Project Aria Academic Partner Announcements, Feedback & Support](https://fb.workplace.com/groups/1137227200340269) or post to our Academic Partners Discord group.
...
Go to the [Quickstart Guide](http://localhost:3000/projectaria_tools/docs/ARK/ARK_quickstart) for ADB commands and MTP instructions.
...
* [Fix USB Driver Issues in Linux](/docs/ARK/troubleshooting/linux_usb_driver)
...
* [How to reduce VRS file size](/docs/ARK/troubleshooting/reduce_vrs_file_size)
...
Trajectory and Eye Gaze derived data can only be generated if they have the necessary sensor data. Go to the [Recording Profiles page](/docs/ARK/glasses_manual/profile_guide) for information about supported profiles.
