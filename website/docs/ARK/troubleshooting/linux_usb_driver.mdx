...
## Overview
If the Aria Desktop app or computer can't detect an Aria device, it may be that your Aria device's battery is drained, or in Linux it may be because of your USB driver.
