...
Preview some Aria open data prior to downloading via the [Aria Dataset Explorer](/open_datasets/dataset_explorer/dataset_explorer.mdx).
...
The [vrs_to_mp4](/data_utilities/advanced_code_snippets/vrs_to_mp4.mdx) script exports a VRS file to MP4 and was created to help researchers send files for review more easily. Please note, MP4 files will not contain the full sensor suite or the time stamps necessary to align with other recordings.
...
* [EgoBlur Demo](https://github.com/facebookresearch/EgoBlur)
    * Apply EgoBlur models to MP4 recordings (uses Conda as the virtual environment)
* [EgoBlur VRS Utilities](https://github.com/facebookresearch/EgoBlur/blob/main/tools/README.md)
    * Apply EgoBlur models to VRS Files (uses Conda as the virtual environment)
...
* [2D Image Coordinate System Conventions](/data_formats/coordinate_convention/2d_image_coordinate_system_convention.mdx)
* [3D Coordinate Frame Conventions](/data_formats/coordinate_convention/3d_coordinate_frame_convention.mdx)
* [Calibration Code Snippets](/data_utilities/core_code_snippets/calibration.mdx)
* [Tech Insights](/tech_insights/tech_insights.mdx)
    * Technical deeper dives on domain-specific topics
