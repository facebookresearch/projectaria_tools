---
sidebar_position: 5
title: Aria Gen 1 FAQ
---

# Aria Gen 1 Docs FAQ

:::caution Aria Gen 1 Documentation
This FAQ covers **Aria Gen 1** only. For Aria Gen 2 docs, visit the [Aria Gen 2 Documentation](https://facebookresearch.github.io/projectaria_tools/gen2/).
:::

This Aria Gen 1 FAQ covers:
