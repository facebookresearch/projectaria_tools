...
* Access calibration data from Project Aria VRS files
  * Python or C++ API ([projectaria_tools/main/core/calibration](https://github.com/facebookresearch/projectaria_tools/blob/main/core/calibration))
* Use Python bindings for the [Sophus Library](https://github.com/strasdat/Sophus) to access to SO3, SE3, interpolate and iterative mean features ([projectaria_tools/main/core/sophus](https://github.com/facebookresearch/projectaria_tools/tree/main/core/python/sophus)).
