...
We also introduce Python binding for the [Sophus Library](https://github.com/strasdat/Sophus), providing access to SO3, SE3, interpolate and iterativeMean features ([projectaria_tools/main/core/sophus](https://github.com/facebookresearch/projectaria_tools/blob/main/core/sophus)).
