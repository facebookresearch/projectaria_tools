...
Aria [Machine perception Services (MPS)](/docs/ARK/mps) provide a convenient way for Aria users to request derived data on any VRS file. Please take a look at [Request MPS](/docs/ARK/mps/request_mps) page to learn more about how to request MPS on your VRS files. In this section, we will learn how to consume the MPS output.
