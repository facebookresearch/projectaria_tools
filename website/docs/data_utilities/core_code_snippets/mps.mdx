...
# filter the point cloud using thersholds on the  inverse depth and distance standard deviation.
...
# Get left- and right-hand confidences and wrist and palm positions in the device frame
# Left-hand side
