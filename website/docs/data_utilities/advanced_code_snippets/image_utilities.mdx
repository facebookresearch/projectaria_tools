...
1. Download devignetting masks from [Link](https://www.projectaria.com/async/sample/download/?bucket=core&filename=aria_camera_devignetting_masks_updated.zip)
