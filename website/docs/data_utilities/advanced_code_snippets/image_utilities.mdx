...
1. Download devignetting masks from [Link](https://www.projectaria.com/async/sample/download/?bucket=core&filename=aria_camera_devignetting_masks.zip)
...
```
```cpp
#include <calibration/utility/Devignetting.h>
...
Go to [projectaria_tools/core/calibration/utility/Devignetting.cpp](https://github.com/facebookresearch/projectaria_tools/blob/main/core/calibration/utility/Devignetting.cpp) for implementation.
