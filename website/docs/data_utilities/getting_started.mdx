...
* **Machine Perception Services (MPS) quickstart tutorial**: a guide to visualizing MPS (derived) data. Content covered includes visualizing:
   * [Eye gaze](/docs/data_formats/mps/mps_eye_gaze)
   * [Trajectory](/docs/data_formats/mps/mps_trajectory)
   * [Point cloud](/docs/data_formats/mps/mps_pointcloud)

You can also explore the open datasets through tutorials:
* Aria Digital Twin (ADT) Tutorials
   * Go to [Getting Started with ADT](/docs/open_datasets/aria_digital_twin_dataset/getting_started) for the introductory tutorial
   * Go to [Advanced Tutorials](/docs/open_datasets/aria_digital_twin_dataset/advanced_tutorials) for multi-person synchronization
* Aria Synthetic Synthetic Environments Tutorial
   * Go to [Getting Started with Synthetic Environments](/docs/open_datasets/aria_synthetic_environments_dataset/ase_getting_started) for this tutorial
...
* [Dataprovider Quickstart Tutorial](https://colab.research.google.com/github/facebookresearch/projectaria_tools/blob/1.3.0/core/examples/dataprovider_quickstart_tutorial.ipynb) - core tutorial
* [Machine Perception Services Tutorial](https://colab.research.google.com/github/facebookresearch/projectaria_tools/blob/1.3.0/core/examples/mps_quickstart_tutorial.ipynb) - core tutorial
* [Aria Digital Twin (ADT)](https://colab.research.google.com/github/facebookresearch/projectaria_tools/blob/1.3.0/projects/AriaDigitalTwinDatasetTools/examples/adt_quickstart_tutorial.ipynb) - open data tutorial
...
* Visualizers
   * [Python](/docs/data_utilities/visualization/visualization_python)
   * [C++](/docs/data_utilities/visualization/visualization_cpp)
