...
title: Basics
---
This page provides an overview of how Project Aria Machine Perception Services (MPS) output files are formatted.

* Go to [MPS Overview](/docs/ARK/mps) for an introduction to MPS
* Go to [Request MPS](/docs/ARK/mps/request_mps) for how to request MPS
