...
If you use Project Aria tools or data in your research, please consider starring ⭐ our [github repository](https://github.com/facebookresearch/projectaria_tools) and citing the Project Aria Whitepaper (details are coming soon).
