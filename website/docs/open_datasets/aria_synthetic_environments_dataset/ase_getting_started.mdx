...
This section will go over everything you need to know to get up and running using Aria Synthetic Environment(ASE) visualisers and data loaders. ASE tooling contains:

* The install instructions specific to ASE
* A quick tutorial which runs through a couple of Jupyter notebook for loading and visualising sample data.
...
### Step 5 : Run the visualisation notebooks
```
