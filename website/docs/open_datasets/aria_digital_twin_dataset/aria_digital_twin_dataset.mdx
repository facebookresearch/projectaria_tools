...
Go to the [Getting Started Tutorial](/docs/open_datasets/aria_digital_twin_dataset/getting_started) to explore the sample dataset (available on Googlecollab, no download necessary) or the [Dataset Download page](/docs/open_datasets/aria_digital_twin_dataset/dataset_download) to get started.
