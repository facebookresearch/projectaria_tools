...
Here you can subselet sequences according to some filter options, or get the links to all sequences.
...
To use the downloader, use the following commands in the vitual environment where you've installed `projectaria_tools`:
