...
Follow Step 0 to Step 3 in [Getting Started](getting_started.mdx).

### Step 1 : Prepare download

Follow Step 1 to Step 3 in [Download the sample ADT sequence](dataset_download.mdx#download-the-sample-aria-digital-twin-adt-sequence)
...
Go to [Data Utilities Troubleshooting](/data_utilities/installation/troubleshooting.mdx) if you experience issues using this guide.
