...
The Fisheye62 model adds two more radial distortion parameters, resulting in 6 radial distortation parameters in total, and tangential distortion on top of the KB3 model parametrized by two new coefficients: p_0 p_1.
$$
