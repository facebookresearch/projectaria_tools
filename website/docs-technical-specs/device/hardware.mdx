...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/img/docs-technical-specs/hardware/rgb-fov.jpg'),
    dark: useBaseUrl('/img/docs-technical-specs/hardware/rgb-fov.jpg'),
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/img/docs-technical-specs/hardware/cv-fov.jpg'),
    dark: useBaseUrl('/img/docs-technical-specs/hardware/cv-fov.jpg'),
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/img/docs-technical-specs/hardware/dynamic-range.jpg'),
    dark: useBaseUrl('/img/docs-technical-specs/hardware/dynamic-range.jpg'),
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/img/docs-technical-specs/hardware/contact-mic.jpg'),
    dark: useBaseUrl('/img/docs-technical-specs/hardware/contact-mic.jpg'),
  }}
/>
...
<ThemedImage
  ...
  sources={{
    light: useBaseUrl('/img/docs-technical-specs/hardware/als.jpg'),
    dark: useBaseUrl('/img/docs-technical-specs/hardware/als.jpg'),
  }}
/>
...
<ThemedImage
  alt="Ambient Light Sensor"
  sources={{
    light: useBaseUrl('/img/docs-technical-specs/hardware/time-alignment.jpg'),
    dark: useBaseUrl('/img/docs-technical-specs/hardware/time-alignment.jpg'),
  }}
/>
