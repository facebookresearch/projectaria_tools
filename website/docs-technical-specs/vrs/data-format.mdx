...
Go to this [python tutorial](https://github.com/facebookresearch/projectaria_tools/blob/2.3.0/examples/Gen2/python_notebooks/Tutorial_3_sequential_access_multi_sensor_data.ipynb) to learn how to access and use the sensor data using Python data utilities.
