...
By default, the single-recording command requests Eye Gaze, SLAM, and Hand Tracking. All three services are supported for Aria Gen1 and Gen2 recordings, subject to the [recording profile requirements](/technical-specs/device/profile) for each service.
