...
title: Basics
---
This page provides an overview of how Project Aria [Machine Perception Services (MPS)](/ark/mps) output files are formatted.
...
For real world data, `tracking_timestamp_us` provides the Device timestamps from your Aria glasses.
