...
Semi-Dense Point Cloud is a Project Aria [Machine Perception Service (MPS)](/ark/mps) that is generated as part of SLAM MPS requests.
...
This file is the gzip compressed semi-dense points in the world coordinate system. The world coordinate frame is the same frame of the closed loop trajectory.
