...
This data can be visualized using the MPS Viewer in [Python](/research-tools/projectariatools/pythontutorials/mps).
...
For the utility function to load the open loop trajectory in Python, please check the [python notebook tutorial](/research-tools/projectariatools/pythontutorials/mps#loading-closed-loop-trajectory)
...
For the utility function to load the closed loop trajectory in Python and C++, please check the [code examples](/research-tools/projectariatools/pythontutorials/mps#loading-open-loop-trajectory)
