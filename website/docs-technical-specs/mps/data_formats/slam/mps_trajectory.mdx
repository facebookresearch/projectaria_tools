...
This data can be visualized using the MPS Viewer in [Python](https://github.com/facebookresearch/projectaria_tools/blob/2.3.0/examples/Gen2/python_notebooks/Tutorial_6_vio_and_trajectory.ipynb).
...
For the utility function to load the open loop trajectory in Python, please check the [python notebook tutorial](https://github.com/facebookresearch/projectaria_tools/blob/2.3.0/examples/Gen2/python_notebooks/Tutorial_6_vio_and_trajectory.ipynb)
...
For the utility function to load the closed loop trajectory in Python and C++, please check the [code examples](https://github.com/facebookresearch/projectaria_tools/blob/2.3.0/examples/Gen2/python_notebooks/Tutorial_6_vio_and_trajectory.ipynb)
