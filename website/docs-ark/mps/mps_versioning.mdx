...
Description: Project Aria's [MPS SLAM service](/technical-specs/mps/data_formats/slam/data_formats) provides the trajectory in 6DoF, a semi-dense point cloud, and the online sensor calibration.

### Multi-SLAM Service

**Current version: 2.0.1**

Description: Project Aria's Multi-SLAM service processes two or more recordings, captured in the same space, together to generate [MPS SLAM outputs](/technical-specs/mps/data_formats/slam/data_formats) in a shared coordinate frame.

### Hand Tracking Service

**Current version: 3.2.0**

Description: Project Aria's [MPS Hand Tracking service](/technical-specs/mps/data_formats/hand_tracking/hand_tracking_outputs) provides the coordinates of 21 hand landmark positions, and the full 6DoF transform from the hand frame (origin at wrist position) to the device frame.
