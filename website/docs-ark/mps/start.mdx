...
> **TODO:** Create a sample dataset for Aria gen2, run through MPS and update the instructions to use the new dataset.
...
Once the request has been processed, the MPS output will be downloaded next to the original VRS file. In this example, a recording in the Example directory called sample2_gen2.vrs was used to generate MPS.

```
    └── Example
        ├── mps_sample2_gen2_vrs
        │   ├── slam
