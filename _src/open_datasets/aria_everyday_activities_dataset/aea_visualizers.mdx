...
`viewer_projects_aea` displays an interactive view of one or two synchronized sequences using [Rerun](/data_utilities/visualization/visualization_python.mdx#an-introduction-to-rerun). It also allows you to see all data in a 3D context.
...
Go to [Visualization of Multi-SLAM data](data_utilities/visualization/visualization_python.mdx#visualization-of-multi-slam-data) for more details.
