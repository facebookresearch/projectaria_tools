...
### Previous versions
The table below includes links to previous versions of Aria Studio across multiple platforms. Note that if you are installing version 1.0.3, you will need to [allow the installation of unsigned builds](#note-version-103-is-an-unsigned-build).
