...
The Project Aria MPS Command Line Interface (MPS CLI), part of Project Aria Tools, is the preferred way to request Machine Perception Services (MPS).
...
1. Once you submit your request, the MPS CLI for the selected mode will open and show the status of your requests.
    * See the Getting Started or the [Command Line Reference](#command-line-reference) below for how to submit a request.
...
* Check [Error Codes](/ARK/mps/mps_troubleshooting.mdx#mps-cli-and-aria-studio-error-codes) to see what the error was.
