...
The CLI or SDK can be used to retrieve the available sensor profiles for recording or streaming stored on your Aria glasses. To make sure you have access to all possible profiles, make sure your [Aria glasses OS](/docs/ARK/mobile_companion_app#update-os) are up to date.
