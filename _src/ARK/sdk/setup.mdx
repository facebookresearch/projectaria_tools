...
* [Downloading and installing the SDK](#step-1-install-sdk-from-pypi)
    * Installing `projectaria_client_sdk` via pip will also add the [Aria CLI](/docs/ARK/sdk/cli/cli.mdx) to your PATH
* [Running Project Aria Doctor to setup your computer and fix common issues](#step-2-run-project-aria-doctor-utility)
* [Pairing your Aria Glasses](#step-3-pair-aria-glasses-with-your-computer)
* [Extracting and exploring the sample apps](#step-4-extract-and-explore-the-sample-apps)
...
- Project Aria glasses that have:
  - Completed full device setup using the [Aria Mobile Companion App](/docs/ARK/mobile_companion_app)
