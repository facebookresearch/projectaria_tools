...
This page provides an overview of how Project Aria device sensor measurements are modeled for IMU, magnetometer, barometer and audio. Go to the [Project Aria FAQ](/faq.mdx#what-calibration-information-is-available) for more calibration information and resources.
