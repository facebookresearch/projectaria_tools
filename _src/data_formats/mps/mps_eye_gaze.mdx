...
For utility function to load the eye gaze in Python and C++, please check the [code examples](/docs/data_utilities/core_code_snippets/eye_gaze_code#load-eye-gaze-in-python-and-c)
