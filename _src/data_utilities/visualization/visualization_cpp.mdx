...
* [Aria Viewer](#run-aria-viewer): visualize raw Aria data
* [MPS 3D Scene Viewer](#run-mps-3d-scene-viewer): renders a static scene using Aria data with trajectories,
global point cloud, and static camera poses
* [MPS 3D Replay Viewer](#run-mps-3d-replay-viewer): renders static scene and dynamic elements: 2D/3D observations rays + eye gaze data
