...
## Overview
This page introduces our core Python visualization tools, developed with [Rerun](#an-introduction-to-rerun), that are part of Project Aria Tools.

* [Aria Sensor Viewer](#run-aria-sensor-viewer): 3D visualization of Aria sensors
* [MPS Viewer](#run-mps-viewer): renders MPS metadata (point cloud, device trajectory and wearer eye gaze)
