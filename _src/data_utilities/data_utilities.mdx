...
title: Overview
---
# Project Aria Tools (Gen 1)

:::caution Aria Gen 1 Documentation
This page covers **Aria Gen 1** tools only. For Aria Gen 2 tools, visit the [Aria Gen 2 Documentation](https://facebookresearch.github.io/projectaria_tools/gen2/).
:::
