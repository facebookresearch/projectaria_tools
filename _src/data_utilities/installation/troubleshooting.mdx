...
1. Update the [AriaViewer](/docs/data_utilities/visualization/visualization_cpp#run-aria-viewer) CMakeLists in
`$HOME/Documents/projectaria_sandbox/projectaria_tools/tools/CMakeLists.txt`
2. Update [AriaDigitalTwinViewer](/docs/open_datasets/aria_digital_twin_dataset/visualizers#step-3--build-ariadigitaltwinviewer) CMakeLists in
