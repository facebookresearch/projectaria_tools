...
* [Save images as PNGs](#save-images-as-pngs)
* Plot raw sensor data from a VRS file and store the plots in PDF files (data is plotted with [Matplotlib](https://matplotlib.org/))
  * [Audio data](#audio)
  * [IMU data](#imu)
  * [Magnetometer](#magnetometer)
  * [Barometer](#barometer)
  * [GPS](#gps)
  * [Wi-Fi beacon](#wi-fi-beacon)
  * [Bluetooth beacon](#bluetooth-beacon)

:::tip Where are the sensors on the glasses?
Use the [Aria Sensor Viewer](/data_utilities/visualization/visualization_python.mdx#run-aria-sensor-viewer) to get the relative position and orientation of most sensors
:::
