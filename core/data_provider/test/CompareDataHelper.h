...
inline void compare(const AlsData& alsData1, const AlsData& alsData2) {
  ...
  EXPECT_FLOAT_EQ(alsData1.visibleChannelNormalized, alsData2.visibleChannelNormalized);
  ...
  EXPECT_FLOAT_EQ(alsData1.visibleFluxWattPerSquareMeter, alsData2.visibleFluxWattPerSquareMeter);
  EXPECT_FLOAT_EQ(alsData1.gainRed, alsData2.gainRed);
  EXPECT_FLOAT_EQ(alsData1.gainGreen, alsData2.gainGreen);
  EXPECT_FLOAT_EQ(alsData1.gainBlue, alsData2.gainBlue);
  EXPECT_FLOAT_EQ(alsData1.gainUv, alsData2.gainUv);
  EXPECT_FLOAT_EQ(alsData1.gainIr, alsData2.gainIr);
  EXPECT_FLOAT_EQ(alsData1.gainClear, alsData2.gainClear);
  EXPECT_FLOAT_EQ(alsData1.gainVisible, alsData2.gainVisible);
