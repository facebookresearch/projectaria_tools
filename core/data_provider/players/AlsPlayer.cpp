...
bool AlsPlayer::onDataLayoutRead(
  ...
  if (r.recordType == vrs::Record::Type::CONFIGURATION) {
    ...
    dataRecord_.visibleChannelNormalized = data.visibleChannelNormalized.get();
    ...
    dataRecord_.visibleFluxWattPerSquareMeter = data.visibleFluxWattPerSquareMeter.get();
    ...
    dataRecord_.gainVisible = data.gainVisible.get();
