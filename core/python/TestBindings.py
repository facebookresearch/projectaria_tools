...
def print_als_data(als_data):
    ...
    print(f"--- Visible Channel (normalized): {als_data.visible_channel_normalized}")
    ...
    print(f"--- Visible Flux (W/m²): {als_data.visible_flux_watt_per_square_meter}")
    ...
    print(f"--- Visible Gain: {als_data.gain_visible}")
