...
```
python eye_gaze_Depth_estimator.py --vrs_file ../../../../data/gen1/mps_sample/sample.vrs --eyegaze_data_file ../../../../data/gen1/mps_sample/eye_gaze/generalized_eye_gaze.csv  --output_csv_filepath gaze_with_depth.csv
```

#### Visualize output

```
viewer_mps --vrs ../../../../data/gen1/mps_sample/sample.vrs --mps_folder ../../../../data/gen1/mps_sample/ --eyegaze gaze_with_depth.csv --points ../../../../data/gen1/mps_sample/trajectory/global_points.csv.gz --trajectory ../../../../data/gen1/mps_sample/trajectory/closed_loop_trajectory.csv
```
